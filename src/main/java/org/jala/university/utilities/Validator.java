...
public class Validator {
  ...
  public static boolean isValidWithdrawal(int withdrawalAmount, int currentBalance, int statusCard) {
    return withdrawalAmount > 0 && withdrawalAmount <= currentBalance && statusCard == 1;
  }
}