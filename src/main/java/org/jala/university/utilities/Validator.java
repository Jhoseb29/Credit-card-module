...
public class Validator {
    ...
    public static boolean isValidWithdrawal(int withdrawalAmount, int currentBalance, int statusCard, int pin, int enteredPin) {
        return withdrawalAmount > 0 && withdrawalAmount <= currentBalance && statusCard == 1 && enteredPin == pin;
    }
}